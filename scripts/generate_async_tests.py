...
def translate_sync_to_async(content: str) -> str:
    # Basic imports
    content = content.replace("from synaflow import run", "from synaflow import async_run\nimport asyncio\nfrom typing import AsyncGenerator, AsyncIterator")
    
    # Replace run_pipeline fixture parameter and invocation
    content = re.sub(r"def test_([a-zA-Z0-9_]+)\(run_pipeline\):", r"@pytest.mark.asyncio\nasync def test_\1():", content)
