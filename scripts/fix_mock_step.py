...
for f in files:
    ...
    content = content.replace("from unittest.mock import MagicMock, call", "from unittest.mock import AsyncMock as MagicMock, call")
    # also fix AsyncGenerator[int | str, None, None] which was missed
    content = content.replace("AsyncGenerator[int | str, None, None]", "AsyncGenerator[int | str, None]")
