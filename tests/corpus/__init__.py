...
EXAMPLES = {
    ...
    "fibonacci": fibonacci_pipeline,
}

__all__ = ["EXAMPLES", "linear_pipeline", "diamond_pipeline", "complex_parallel_pipeline", "complex_parallel_mixed_pipeline", "fibonacci_pipeline"]
