...
class EventDispatcher:
    ...
    def resolve_step_observers(self, node: Any, step_name: str) -> list:
    ...
    def step_started(self, node: Any, step_name: str) -> None:
        registrations = self.resolve_step_observers(node, step_name)
        if not registrations:
            return
